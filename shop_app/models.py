...
class CategoryManager(models.Manager):
    CATEGORY_NAME_COUNT = {
        'Брюки и юбки': 'bottomwear__count',
        'Футболки и толстовки': 'topwear__count',
        'Платья': 'dresses__count',
        'Сумки': 'bags__count'
    }
    ...
    def get_categories_for_sidebar(self):
        models = get_models_for_count('dresses', 'bags', 'topwear', 'bottomwear')
